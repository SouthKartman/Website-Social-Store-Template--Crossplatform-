	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>Понравившиеся</li>
			</ul>
...
<div class="body-content outer-top-bd">
	...
	<div class="table-responsive">
		<table class="table">
			<thead>
				<tr>
					<th colspan="4">Ваш список понравившихся товаров</th>
				</tr>
			</thead>
			<tbody>
<?php
...
?>
						...
						<?php } ?>
						<div class="price">
							<?php echo htmlentities($row['pprice']);?>.00 руб.
							<span>$900.00</span>
						</div>
					</td>
					<td class="col-md-2">
					...
					<td class="col-md-2 close-btn">
						<a href="my-wishlist.php?del=<?php echo htmlentities($row['wid']);?>" onClick="return confirm('Вы уверены что хотите удалить товар?')" class=""><i class="fa fa-times"></i></a>
					</td>
				</tr>
				<?php } } else{ ?>
				<tr>
					<td style="font-size: 18px; font-weight:bold ">Список понравившихся товаров пуст</td>
