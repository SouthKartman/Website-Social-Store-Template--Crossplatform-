...
header('location:login.php');
	...
	if(isset($_POST['update']))
	{
		...
		if($query)
		{
echo "<script>alert('Ваши данные обновлены');</script>";
		}
	}
...
echo "<script>alert(Ваш пароль поменян успешно !!');</script>";
}
else
{
...
<div class="form-group">
			 ...
			 <input type="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" value="<?php echo $row['email'];?>" readonly>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Contact No.">Контактный номер <span>*</span></label>
...
<div class="form-group">
					    <label class="info-title" for="Current Password">Текущий пароль<span>*</span></label>
			 ...
			 <input type="password" class="form-control unicase-form-control text-input" id="newpass" name="newpass">
					  ...
					  <button type="submit" name="submit" class="btn-upper btn btn-primary checkout-page-button">Поменять </button>
					</form> 
