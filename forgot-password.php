...
<html lang="en">
	<head>
	    ...
	    <title>PhotoCenter | Забыли пароль</title>
...
?>
		...
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    <label class="info-title" for="exampleInputPassword1">Контактный номер <span>*</span></label>
...
<div class="form-group">
	  	...
	  	<button type="submit" class="btn-upper btn btn-primary checkout-page-button" name="change">Поменять</button>
	</form>					
</div>
<!-- Sign-in -->
