...
$_SESSION['msg']="Подкатегории созданы !!";
...
<head>
	...
	<title>Meneger| Подкатегории</title>
...
{?>
									...
									<strong>Обновлено!</strong>	<?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?>
									</div>
<?php } ?>
...
<label class="control-label" for="basicinput">Категории</label>
<div class="controls">
<select name="category" class="span8 tip" required>
<option value="">Выбирите категории</option> 
...
<div class="control-group">
<label class="control-label" for="basicinput">Меню подкатегорий</label>
<div class="controls">
<input type="text" placeholder="Введите имя подкатегории"  name="subcategory" class="span8 tip" required>
</div>
</div>
