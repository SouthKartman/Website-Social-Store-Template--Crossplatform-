...
<head>
	...
	<title>Meneger| Редактирование продуктов</title>
...
{?>
									...
									<strong>Обнволено!</strong>	<?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?>
									</div>
<?php } ?>
...
<div class="control-group">
<label class="control-label" for="basicinput">Подкатегории</label>
<div class="controls">
...
<div class="controls">
<input type="text"    name="productName"  placeholder="Введите имя продукта" value="<?php echo htmlentities($row['productName']);?>" class="span8 tip" >
</div>
</div>
...
<div class="controls">
<input type="text"    name="productCompany"  placeholder="Введите компанию продукта" value="<?php echo htmlentities($row['productCompany']);?>" class="span8 tip" required>
</div>
</div>
<div class="control-group">
<label class="control-label" for="basicinput">Цена продукта без скидки</label>
<div class="controls">
<input type="text"    name="productpricebd"  placeholder="Введите цену" value="<?php echo htmlentities($row['productPriceBeforeDiscount']);?>"  class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="productShippingcharge"  placeholder="Введите стоимость доставки продуктаe" value="<?php echo htmlentities($row['shippingCharge']);?>" class="span8 tip" required>
</div>
</div>
