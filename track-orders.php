	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>Отследить покупку</li>
			</ul>
...
<div class="body-content outer-top-bd">
	...
	<span class="title-tag inner-top-vs">Пожалуйста введите ваш номер заказ и нажмите Enter. Это было указано в квитанции или в письме с подтверждением, которое вы должны были получить. </span>
	<form class="register-form outer-top-xs" role="form" method="post" action="order-details.php">
		<div class="form-group">
	  	...
	  	<button type="submit" name="submit" class="btn-upper btn btn-primary checkout-page-button">Заказ</button>
	</form>	
</div>			</div><!-- /.row -->
		</div><!-- /.sigin-in-->
		<!-- ============================================== BRANDS CAROUSEL ============================================== -->
