...
header('location:.php');
	...
	if(isset($_POST['update']))
	{
		...
		if($query)
		{
echo "<script>alert('Адрес был обновлен успешно');</script>";
		}
	}
...
// code for Shipping address updation
	if(isset($_POST['shipupdate']))
	{
		...
		if($query)
		{
echo "<script>alert('Ваш адрес был обновлен успешно');</script>";
		}
	}
	...
	<!-- panel-heading -->
    	...
    	<h4 class="unicase-checkout-title">
	        <a data-toggle="collapse" class="" data-parent="#accordion" href="#collapseOne">
	          <span>1</span>Адрес для выставления счёта
	        </a>
	     </h4>
    </div>
    <!-- panel-heading -->
...
<div class="form-group">
					    <label class="info-title" for="Billing Address">Адрес<span>*</span></label>
...
?>
					...
					<form class="register-form" role="form" method="post">
<div class="form-group">
					    <label class="info-title" for="Shipping Address">Адрес<span>*</span></label>
