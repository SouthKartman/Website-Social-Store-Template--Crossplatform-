					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
									<?php echo htmlentities($rws['productPrice']);?>.00 руб.
								</span>
									
							    <span class="price-before-discount"><?php echo htmlentities($row['productPriceBeforeDiscount']);?>Руб.</span>					
						...
						<div class="cart clearfix animate-effect">
							...
							<!-- <button class="btn btn-primary" type="button">Добавить в корзину</button></a> -->
								<?php } else {?>
							<!-- <div class="action" style="color:red">Заказать</div> -->
					<?php } ?>
...
?>		
							<div class="rating-reviews m-t-20">
								<div class="row">
									...
									<div class="col-sm-8">
										<div class="reviews">
											<a href="#" class="lnk">(<?php echo htmlentities($num);?> Отзывов)</a>
										</div>
									</div>
								</div><!-- /.row -->		
							</div><!-- /.rating-reviews -->
...
<div class="stock-container info-container m-t-10">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price"> <?php echo htmlentities($row['productPrice']);?>руб.</span>
											<span class="price-strike"><?php echo htmlentities($row['productPriceBeforeDiscount']);?>руб.</span>
										</div>
									</div>
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-7">
<?php if($row['productAvailability']=='In Stock'){?>
										<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> В корзину</a>
													<?php } else {?>
							<div class="action" style="color:red">Нет в продаже</div>
					<?php } ?>
									</div>
								...
								<div id="review" class="tab-pane">
									<div class="product-tab">
										...
										<div class="product-reviews">
											<h4 class="title">Отзывы людей</h4>
...
?>
											...
											<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
												<div class="review">
													...
													<div class="text"><b>Качество :</b>  <?php echo htmlentities($rvw['quality']);?> Звёзды</div>
													<div class="text"><b>Цена :</b>  <?php echo htmlentities($rvw['price']);?> Звёзды</div>
													<div class="text"><b>Цена-качество :</b>  <?php echo htmlentities($rvw['value']);?> Звёзды</div>
										...
										<div class="product-add-review">
											<h4 class="title">Напиши и ты свой отзыв</h4>
												...
												<div class="form-container">
														...
														<div class="row">
															<div class="col-sm-6">
																...
																<div class="form-group">
																	<label for="exampleInputSummary">Загаловок <span class="astk">*</span></label>
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label for="exampleInputReview">Обзор <span class="astk">*</span></label>
...
<textarea class="form-control txt txt-review" id="exampleInputReview" rows="4" placeholder="" name="review" required="required"></textarea>
														...
														<div class="action text-right">
															<button name="submit" class="btn btn-primary btn-upper">Опубликовать обзор</button>
														</div><!-- /.action -->
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					<?php echo htmlentities($rw['productPrice']);?>Руб.			</span>
										     <span class="price-before-discount">
										     <?php echo htmlentities($rw['productPriceBeforeDiscount']);?>руб.</span>
