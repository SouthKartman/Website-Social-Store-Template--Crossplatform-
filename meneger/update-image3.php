					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Обновление фото продукта</h3>
							</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Текущее фото продукта</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Новое фото 3 продукта</label>
<div class="controls">
