...
<head>
	...
	<title>Meneger| Update Product Image</title>
...
<div class="control-group">
<label class="control-label" for="basicinput">Текущее фото 1</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Новое первое фото</label>
<div class="controls">
