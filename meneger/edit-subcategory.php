...
<head>
	...
	<title>Meneger| Редактирование субкатегории</title>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Редактирование субкатегории</h3>
							</div>
...
{?>
									...
									<strong>Выполнено!</strong>	<?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?>
									</div>
<?php } ?>
...
<div class="control-group">
<label class="control-label" for="basicinput">Имя субкатегории</label>
<div class="controls">
