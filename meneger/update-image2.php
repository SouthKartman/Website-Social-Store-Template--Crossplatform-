...
$_SESSION['msg']="Фото успешно обновлено !!";
...
<head>
	...
	<title>Meneger| Обновление фото продукта</title>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Обновление фото 2 продукта</h3>
							</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Текущее фото2 продукта</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Новое фото 2 продукта</label>
<div class="controls">
