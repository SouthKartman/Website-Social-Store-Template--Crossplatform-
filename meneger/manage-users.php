...
if(isset($_GET['del']))
		  {
                  ...
                  $_SESSION['delmsg']="Продукт удален !!";
		  }
...
<head>
	...
	<title>Meneger| Менеджер Пользователей</title>
								...
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									<thead>
										<tr>
											...
											<th>Адрес доставки/Город/Область/Почтовый индекс</th>
											<th>Платежный адрес/Город/Область/Почтовый индекс</th>
